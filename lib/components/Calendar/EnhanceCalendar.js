...
var EnhanceCalendar = function EnhanceCalendar(WrapComponent) {
  ...
  MComponent.propTypes = {
    defaultDate: _propTypes["default"].oneOfType([_propTypes["default"].shape(), _propTypes["default"].arrayOf(_propTypes["default"].oneOfType([_propTypes["default"].instanceOf(_moment["default"]), _propTypes["default"].string]))]),
