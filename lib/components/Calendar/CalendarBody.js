...
function (_React$Component) {
  ...
  _createClass(CalendarBody, [{
    ...
    value: function renderNextMonthDays(start, count) {
      var emptyDays = [];
      var i = 1;
      start = (0, _moment.default)(start).add(i, 'days');
    ...
    value: function render() {
      ...
      var renderRowDays = function renderRowDays(days) {
        return days.map(function (item) {
          ...
          var disableDownEvent = !item.isDisable && item.inMonth;
          ...
          return _react.default.createElement("div", {
            ...
            onMouseDown: function onMouseDown() {
              return disableDownEvent && _this2.handleMouseDown(event, item.date);
            },
...
var propTypes = {
  ...
  // select day range
  itemRender: _propTypes.default.func // day item render function
